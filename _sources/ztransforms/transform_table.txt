...
This table gives z-transforms of particular functions. In table [#ftable1]_ we use the following definitions:
...
.. csv-table::
    ...
    Sequence, :math:`x[n]`; Z-transform, :math:`X(z)`; radius of convergence
...
.. [#ftable1] This  is a modified version of a table on the `Wikipedia Page <http://en.wikipedia.org/wiki/Z-transform>`_.
