...
.. [#fdiff1] Doing this obtains the equation :math:`x(k) = x(0) + T \sum_{j=0}^{k-1} y(j)`.
.. [#fdiff2] Since we are integrating from 0 to 2 then :math:`n=0` and we are given a function :math:`y(k) = k^2 + 1`
